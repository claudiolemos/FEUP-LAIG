...
class CameraAnimation {
   ...
   * @param {CGFcamera} from initial camera
   * @param {CGFcamera} to   final camera
   */
  ...
  /**
   * initializes all the necessary vectors
   */
  init() {
  ...
  /**
   * calculates the position, direction and velocity vectors
   */
  calculate() {
  ...
  /**
   * Checks if animation has reached the final camere
   * @return {boolean} true if animation is finished, false if not
   */
  finished() {
